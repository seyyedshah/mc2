...
/**
 * This is the item provider adapter for a {@link mc2.DataClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataClassItemProvider extends DataConceptItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataClass_classifies_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataClass_classifies_feature", "_UI_DataClass_type"),
				 Mc2Package.Literals.DATA_CLASS__CLASSIFIES,
				 true,
				 false,
				 true,
				 null,
