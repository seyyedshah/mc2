...
public class FTuple_DataConcept2EObjectDataConcept8 implements Rule<FTuple,EObject>{
	...
	public boolean check(FTuple source){
		...
		//check the FTuple is a tuple of the get_DataConcept relation 
		return source.instanceOf( ((ModelGenerator4Catalogue)source.getInstance().getMetaModel()).get_DataConcept() );
	}
	...
	public EObject build(FTuple source, Transformer t){
		...
		EClass metaClass = (EClass) metaModel.getEObject( "//DataConcept" );
