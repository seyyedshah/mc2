...
public class FTuple_Type2EObjectType19 implements Rule<FTuple,EObject>{
	...
	public boolean check(FTuple source){
		...
		//check the FTuple is a tuple of the get_Type relation 
		return source.instanceOf( ((ModelGenerator4Catalogue)source.getInstance().getMetaModel()).get_Type() );
	}
	...
	public EObject build(FTuple source, Transformer t){
		...
		EClass metaClass = (EClass) metaModel.getEObject( "//Type" );
